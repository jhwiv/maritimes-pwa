...
| Maritimes Grand Loop | [maritimesgrandloop.com](https://maritimesgrandloop.com) | `jhwiv/maritimes-pwa` | **v1.10** | 27 Mar 2026 |
...
| Two-tier search + walk time | `SEARCH_TWOTIER` | ✓ v3.26 | ✓ v1.10 | 500m→1200m radius, distance sort, walk time, GM fallback |
